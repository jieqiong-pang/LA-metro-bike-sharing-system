<template>
  <div class="dv_chart_container_all">
    <h3>Bottom 10 Popular Stations</h3>
    ...
    <div id="b10_id_chart_b10" class="dv_chart_container"></div>
  </div>
</template>
...
export default {
  ...
  computed: {
    pth_data() {
      return `${this.$store.state.publicPath}system/bottom_10/${this.yearSeason}.json`;
    },
  },
  watch: {
    pth_data() {
